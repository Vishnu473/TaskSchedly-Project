...
const TaskCard = ({task}) => {
  ...
  return (
    <>
      <div className="p-4 shadow-lg rounded-md relative min-h-44 w-80 border bg-white">
      ...
      {/* {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black z-50 bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            />
            <button onClick={handleClose} className="px-4 py-2 bg-green-500 text-white rounded-md">Save</button>
          </div>
        </div>
      )} */}
    </>
